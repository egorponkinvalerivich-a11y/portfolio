const products = [
  ...
  {id:"bridal-silver",name:"BRIDAL / SILVER",collection:"bridal",category:"BRIDAL",tone:"Серебристый",cover:"assets/img/campaign/product-bridal-silver.webp",hover:"assets/img/campaign/model-bridal-silver.webp",desc:"Серебристая кристальная модель для особенного дня."},
  {id:"bridal-white",name:"BRIDAL / WHITE",collection:"bridal",category:"BRIDAL",tone:"Белый",cover:"assets/img/campaign/product-bridal-white.webp",hover:"assets/img/campaign/model-bridal-white.webp",desc:"Белая bridal-модель с выразительной фактурой."}
];

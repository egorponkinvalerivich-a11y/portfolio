const products = [
  ...
  {id:"beaded-rose",name:"ARCH / ROSE",collection:"beaded",category:"BEADED",tone:"Розовый",cover:"assets/img/campaign/product-rose.webp",hover:null,desc:"Арочная сумка из бусин в розовой палитре."},
  ...
  {id:"beaded-blue-iridescent",name:"ARCH / BLUE IRIDESCENT",collection:"beaded",category:"BEADED",tone:"Синий иридисцентный",cover:"assets/img/campaign/product-blue.webp",hover:null,desc:"Переливающаяся синяя арочная модель."},
  {id:"beaded-scarf-blue",name:"SCARF / BLUE",collection:"beaded",category:"BEADED",tone:"Голубой",cover:"assets/img/campaign/model-blue.webp",hover:null,desc:"Синяя scarf-handle модель из крупных матовых бусин с текстильными акцентами на ручке."},
  ...
  {id:"beaded-gold",name:"GOLD",collection:"beaded",category:"BEADED",tone:"Золотистый",cover:"assets/img/campaign/product-gold.webp",hover:null,desc:"Золотистая модель из бусин ручной сборки."},
  ...
  // BRIDAL — low-resolution secondary assets are intentionally disabled until HQ originals are stored safely.

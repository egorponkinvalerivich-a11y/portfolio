const products = [
  ...
  {id:"beaded-blue-iridescent",name:"ARCH / BLUE IRIDESCENT",collection:"beaded",category:"BEADED",tone:"Синий иридисцентный",cover:"assets/img/campaign/product-blue.webp",hover:null,desc:"Переливающаяся синяя арочная модель. Фото другой синей сумки на модели не используется как hover."},
